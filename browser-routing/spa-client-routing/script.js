...
const aboutUs = () => {
  ...
  <section id="about">
      <h1>About Us</h1>
      <p>We are building a minimal router using plain JavaScript to understand how client-side routing works.</p>
  </section>`;
};
const contactUs = () => {
	return `
  <section id="contact">
      <h1>Contact Us</h1>
      <p>If you have any questions, feel free to reach out via email at <a href="mailto:info@example.com">info@example.com</a>.</p>
  </section>`;
};
